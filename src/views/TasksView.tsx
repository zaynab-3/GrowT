  ...
  return (
    <div className="flex-1 w-full max-w-7xl mx-auto flex flex-col gap-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-headline-lg text-headline-lg md:font-headline-lg md:text-headline-lg text-on-surface flex items-center gap-3">
            Standalone Tasks
      ...
      <div className="flex flex-col gap-8">
        {folderTaskCount > 0 || (folderDetail && !folderDetail.toString().includes('empty')) ? (
          <section className="bg-light-card dark:bg-dark-card rounded-[18px] p-6 shadow-[0_4px_16px_0_rgba(31,38,135,0.03)] border border-surface-variant/50">
